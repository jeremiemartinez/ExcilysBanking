...
public class OperationDAOImpl extends AbstractDAOQueryDSLHelper implements OperationDAO {
	...
	@Override
	public Double findTotalMontantOperationsCarteByCompteId(Integer compte_id) {
		log.debug("Calling Method findTotalMontantOperationsCarte");
	...
	@Override
	public List<Operation> findOperationsNonCarteByCompteId(Integer compte_id) {
		log.debug("Calling Method findOperationsNonCarte");
	...
	public List<Operation> findOperationsCarteByCompteId(Integer compte_id) {
		log.debug("Calling Method findOperationsCarte");
