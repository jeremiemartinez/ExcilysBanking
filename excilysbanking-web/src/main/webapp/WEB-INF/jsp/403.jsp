...
<body>
	...
	<div class="row-fluid">
		...
		<div class="span4">
			<br />
			<div class="hero-unit">
				<h1><spring:message code="error.name403"/></h1>
				<br />
				<p>
					<i class="icon-info-sign"></i> <spring:message code="error.description403"/>
				</p>
				<br />
				<p><a class="btn btn-primary btn-large" href="/index.html"><spring:message code="error.return"/> &raquo;</a></p>
			</div>
		</div>
		<div class="span4"></div>
	</div>
