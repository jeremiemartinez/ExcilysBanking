		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<div class="btn-group pull-right">
					...
					<a class="btn dropdown-toggle" data-toggle="dropdown"> <i class="icon-user"></i> ${user.firstname} ${user.lastname} <span
						class="caret"></span>
					</a>
					
					<ul class="dropdown-menu">
						<li><a href="../../index"><i class="icon-home"></i>&nbsp; &nbsp; <spring:message code="admin.return" /></a></li>
						<li class="divider"></li>
						<li><a href="../comptes"><i class="icon-user"></i>&nbsp; &nbsp; <spring:message code="admin.userInterface" /></a>
						<li class="divider"></li>
						<li><a href="<c:url value="/j_spring_security_logout"/>"><i class="icon-off"></i>&nbsp; &nbsp; <spring:message code="admin.disconnect" /></a></li>
					</ul>
				</div>
				<div class="tabbable">
