						...
						<tbody>
							...
							<tr>
								...
								<td colspan=4><div id="operationsCarte" class="collapse">
										...
										<h4>Page <span id="cartesPageNumber"/></h4>
										...
										<ul class="pager">
											<li id="cartePagerNext" class="next">
												<a href="#" id="cartesNewest"><spring:message code="paging.newest" />&rarr;</a>
												<a href="#" id="cartesNewer"><spring:message code="paging.newer" /></a>
											</li>
											<li id="cartePagerPrevious" class="previous">
												<a href="#" id="cartesOldest">&larr;<spring:message	code="paging.oldest" /></a>
												<a href="#" id="cartesOlder"><spring:message code="paging.older" /></a>
											</li>
										</ul>
